...
//		count = 1;
//
//	else if (strncmp(rx_buff, "123456", 6))
//		count = 0;
//
//	else count = 2;
//
//	 HAL_UART_Transmit(&huart1,count,sizeof(count),30);
  while (1){
...
//	  HAL_UART_Receive_IT(&huart1,rx_buff,6);
//	  	if (!strncmp(rx_buff,"123456", 6))
//	  		HAL_UART_Transmit(&huart1,"true",4,30);
//	  	else
//	  		HAL_UART_Transmit(&huart1,"false",5,30);
//	  HAL_Delay(500);

//	  HAL_UART_Receive_IT(&huart1,rx_buff,6);
//	  if (!strncmp(rx_buff, "123456", 6) && count == 1){
//	  	  HAL_UART_Transmit(&huart1,str1,sizeof(str1),30);
//	  	  count = 2;
//	  }
//	  else if (strncmp(rx_buff, "123456", 6) && count == 0){
//		  HAL_UART_Transmit(&huart1,str2,sizeof(str2),30);
//		  count = 2;
//	  }
  }
